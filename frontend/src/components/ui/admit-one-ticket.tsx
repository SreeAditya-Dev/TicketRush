...
function AdmitOneTicket({ tilt = true, children = null, ...props }: { tilt?: any; children?: any; [x: string]: any }) {
  const width = props.width ?? REF;
  const geometry = props.geometry ?? TICKET_GEOMETRY;
  if (tilt === false) return /* @__PURE__ */ jsx4(TicketCard, { ...props, children });
  return /* @__PURE__ */ jsx4(
    TiltCard,
    {
      clipPath: `path('${ticketClipPath(width, width / geometry.aspect, geometry)}')`,
      ...tilt,
      children: /* @__PURE__ */ jsx4(TicketCard, { ...props, children })
    }
  );
}
